...
// Surface module-loading failures in both the page and DevTools.  Without this,
...
requirejs.onError = function (error) {
  ...
  if (app) {
    app.innerHTML = '<section class="oj-sm-padding-6x-vertical oj-sm-padding-4x-horizontal">' +
      ...
      '<p>Please refresh the page. If this continues, check the browser console for the loading error.</p>' +
      '</section>';
  }
  throw error;
};
