...
public class EodController {
    ...
    EodRunResponse start(@RequestHeader("Idempotency-Key") @NotBlank String key,
        ...
        return service.start(key, request);
    }
    ...
    EodRunResponse resume(@PathVariable String runId, @RequestBody @Valid EodResumeRequest request) {
    ...
    EodRunResponse retry(@PathVariable String runId, @PathVariable String stepCode,
        ...
        return service.retry(runId, stepCode);
    }
