...
class ClientCredentialsTokenProvider {
    ...
    ClientCredentialsTokenProvider(
            ...
            @Value("${moneybags.security.m2m.scope:payment:service account:service card:eod billing:service accounting:service notification:service statements:service}") String scope) {
