...
public record UpdateCifRequest(
    ...
    public UpdateCifRequest withIdentityEmail(String identityEmail) {
        return new UpdateCifRequest(firstName, lastName, dob, age, identityEmail, number, address,
