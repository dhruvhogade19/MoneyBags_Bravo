...
For local Swagger access without a JWT, set `BILLING_SECURITY_ENABLED=false`. This override applies only to Billing; the shared `SECURITY_ENABLED` setting remains unchanged for the other services.
