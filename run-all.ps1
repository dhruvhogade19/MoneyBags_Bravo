...
$services = @(
    ...
    @{ Name = "eod-reconciliation-service"; Directory = "eod-reconciliation-service"; Port = 8091 },
...
Write-Host "EOD API : http://localhost:8091/swagger-ui.html" -ForegroundColor Green
...
Write-Host "Follow EOD logs: Get-Content .\logs\eod-reconciliation-service.out.log -Wait -Tail 100"
