...
- `openapi/*.openapi.json` - one OpenAPI 3.x definition per business service.
...
Final contract audit: **PASS**; 12 services, 133 endpoints, 139 named API schemas, and 39 resolved synchronous dependency calls.
