...
public class AccountStatementLine {
    ...
    public AccountStatementLine(String id, AccountStatement statement, int sequence, OffsetDateTime occurredAt,
    ...
    public int getSequence() { return sequence; } public OffsetDateTime getOccurredAt() { return occurredAt; }
